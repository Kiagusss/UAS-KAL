...
from benchmark_models import run_lstm
from ml_common import load_labeled_dataframe, set_seed


def main():
    parser = argparse.ArgumentParser(description="Train and evaluate LSTM on labeled YouTube comments")
    ...
    df = load_labeled_dataframe(
        ...
        text_candidates=("cleaned_lstm", "cleaned_text", "text"),
    )
